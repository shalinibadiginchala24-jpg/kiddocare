...
export const onSOSActivated = functions.firestore
...
export const dailyMidnightReset = functions.pubsub.schedule('0 0 * * *').timeZone('America/New_York').onRun(async (context) => {
